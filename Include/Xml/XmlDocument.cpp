...
namespace details
{
	...
	inline string::const_iterator seekForIgnorable(string::const_iterator pos, string::const_iterator end) noexcept
	{
		return AnsiCharUtils::SeekFor(pos, end, isIgnorable);
	}
	inline  string::const_iterator seekForNonIgnorable(string::const_iterator pos, string::const_iterator end) noexcept
	{
